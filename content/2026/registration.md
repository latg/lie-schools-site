...
<!--Для регистрации на двенадцатую школу-конференцию заполните форму по [ссылке](https://docs.google.com/forms/d/e/1FAIpQLSfrUWtyZjzz8HClxvaBgtvEe65HjbS4rcT9cuKbcAzqFdUu4Q/viewform?usp=dialog). Кроме устных докладов на школе запланирована постерная сессия.-->
Отправить тезисы докладов и файлы постеров можно на почту школы-конференции [lie.algebras26@gmail.com](mailto:lie.algebras26@gmail.com).
